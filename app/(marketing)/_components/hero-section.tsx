...
import HeroLight from "@/public/screenshot2.png";
import HeroDark from "@/public/screenshot.png";
import ArcjetLogo from "@/public/arject.png";
          ...
          <div className="relative pt-24 md:pt-36">
            ...
            <div className="mx-auto max-w-7xl px-6">
              <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                ...
                >
                  TailFlow organizes conversations, tasks, and AI tools in one
                  seamless platform, boosting team productivity and
                  collaboration.
                </TextEffect>
